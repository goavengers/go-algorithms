...
Два вложенных цикла дадут нам асимптотику вида O(n) = n^2.
...
- Одиночный цикл в n итераций даёт O(n) = n. 
- Цикл внутри цикла — O(n) = n^2. 
- Цикл внутри цикла внутри цикла — O(n) = n^3. И так далее.
