...
- Но мы понимаем, что n^2 + n^2 == n^2
- Так же мы понимаем, что n^2 > n, следовательно если она меньше то не влияет на сложность алгоритма
...
- O(5 * 2^n + 10 * 2^100) константы мы помним можно отбрасывать -> O(2^n * 2^100) = O(2^n), т.к. экспоненциальное время 2^n намного больше степенной.
