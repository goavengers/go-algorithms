...
Думаете __O(log n)__? Казалось бы да, но нет.

__Ответ:__ O(n/2), т.к. мы просто __один раз__ идем до половины элементов массива, следовательно сложность алгоритма O(n)
